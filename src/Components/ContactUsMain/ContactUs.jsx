...
const ContactUs = () => {
  ...
  const config = {
    animate: true,
    arrowIcon: <HiOutlinePlus />,
    expandIcon: <HiOutlinePlus />,
    collapseIcon: <HiOutlineMinus />,
    tabFocus: true,
  };
  return (
    <>
          ...
          <div className="row">
            <div className="col-5">
              <p className="contactUs-content">
                ...
                Feedback, Or a Collaboration Idea, Feel Free To Reach Out To
                Us...
              </p>
              <div className="contact-icon-box d-flex justify-content-between mt-2">
                <a href="#">
                  <img src="assets/Images/insta.png" width={40} alt="" />{" "}
                </a>
                <a href="#">
                  <img src="assets/Images/X.png" width={40} alt="" />
                </a>
                <a href="#">
                  <img src="assets/Images/web.png" width={40} alt="" />
                </a>
                <a href="#">
                  <img src="assets/Images/linkedin.png" width={40} alt="" />
                </a>
                <a href="#">
                  <img src="assets/Images/fb.png" width={40} alt="" />
                </a>
              </div>
              <CircleSmall />
            </div>
              ...
              <form action="">
                <div className="contact-searchbar  mt-4">
                  <input
                    type="text"
                    id="newsletterSearch"
                    className="contact-input form-control ps-4 bg-transparent"
                ...
                <div className="text-area">
                  <textarea
                    className="contact-text-area  mt-3"
            ...
            <div className="col">
              ...
              <div className="contact-cards d-flex  ">
                ...
                <div className="contact-card mx-3 ">
                  ...
                  <p className="contactcard-title2 ">
                    .....................................................
                  </p>
                </div>
              </div>
