...
<>
            ...
            <BsArrowRightCircleFill className="latestpost-right-arrow-icon   mt-3" color="white" size="2em" />
                        ...
                        <div className="latestposts mt-5">
                            <div className="latestpost-img-main">
                                <img  src="public/assets/Images/img1.png" alt="" width={450}/>
                            </div>
                            <div className="latestpost-title">
                                ...
                                <img src="public/assets/Images/line.png" width={444} alt="" />      
                            </div>

                            <div className="latestpost-author-sec d-flex text-white">
    <img src="public/assets/Images/author1.png" alt="Author" width={50} />
    <div className="author-info">
        <p >Leslie Alexander</p>
        <p className='author-info-date'>Ceo / April 22, 2024</p>
    </div>
    <img src="public/assets/Images/arrow-btn.png" className='latestpost-arrow-icon' alt="" width={50} />
</div>
         ...
         <div className="latestpost-container mt-4 d-flex justify-content-between">
            ...
            <div className="latestpost-img d-flex">
                                <img src="public/assets/Images/img1.png" alt="" width={180} height={180}/>
                            </div>
                            <div className="latestpost1-title">
                                ...
                                <img src="public/assets/Images/line.png" width={180} alt="" />      
                            </div>
                            <div className="latestpost1-author-sec d-flex  text-white">
    <img src="public/assets/Images/author1.png" alt="Author" width={30} height={30} />
    ...
    <img src="public/assets/Images/arrow2.png" className='latestpost1-arrow-icon' alt="" width={25} height={30} />
</div>
            ...
            <div className="latestpost-img d-flex">
                                <img src="public/assets/Images/img2.png" alt="" width={180} height={180}/>
                            </div>
                            <div className="latestpost1-title">
                                <p className="latestpost1-title-heading mt-4 fs-6 fw-light">Lorem ipsum dolor sit amet consectetur adipiscing... </p>
                                <img src="public/assets/Images/line.png" width={180} alt="" />      
